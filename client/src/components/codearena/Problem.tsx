...
const Problem = () => {
  ...
  const [submitStatus, setSubmitStatus] = useState<"isCompilerError" | "isNotMatch" | "passed">("passed")
          ...
          <Card className="flex flex-col flex-1 overflow-hidden">
            ...
            <CardContent className="p-6 overflow-y-auto flex-1">
              ...
              <div className="text-white">
                {submitStatus === "isCompilerError" ? <div>{compilerError}</div> : 
                submitStatus === "isNotMatch" ? <>
                <p>{expected}</p>
                <p>{actual}</p>
                </> : <>
                passed</>}
