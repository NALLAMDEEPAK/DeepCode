...
4`);
  ...
  const CodeLoader = () => {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 h-52 overflow-hidden">
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div
        className={`mt-4 bg-gray-800 text-gray-200 font-mono text-sm p-4 rounded-lg max-h-52 ${
